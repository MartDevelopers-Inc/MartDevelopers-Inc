...
<div id="large-header" class="large-header">
	...
	<h1 class="main-title">Cayman <span class="thin wow pulse" data-wow-duration="1.8s" data-wow-delay="0.5s" data-wow-iteration="3">Theme</span><br/>
	<span class="smallh wow zoomIn"> Bootstrap Responsive HTML Template </span><br/>
	<button type="button" class="btn btn-default wow fadeInLeft">Tell me more</button>
	<button type="button" class="btn btn-primary wow fadeInRight">Purchase now</button>
	</h1>
</div>
<!-- Features
================================================== -->
